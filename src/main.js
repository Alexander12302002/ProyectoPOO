...
function juegoPrincipal() {
        while (true) {
            if (juego.monstruo && juego.monstruo.vida > 0) {
                const accion = prompt("¿Qué quieres hacer? 'Atacar' (o 'Salir' para terminar el juego)");
                ...
                const accion = prompt("¿Qué quieres hacer? 'Investigar' (o 'Salir' para terminar el juego)");
